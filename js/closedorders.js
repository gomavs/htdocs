$(document).ready(function() {
	...
	$(".btn-reopen").live("click", function() {
		$.post("/ajax/reopen.php", {id:$(this).parent().parent().prev().children().eq(0).html()}, function() {
			window.location = "/openorders";
		});
	});
});